...
export default function ReceiveScreen() {
  ...
  const qrValue = receiveType === "BEAMPAY" ? blinkId : sep0007Uri;
  ...
  const handleShare = async () => {
    try {
      const shareValue = receiveType === "BEAMPAY" ? blinkId : walletAddress;
  ...
  const renderStep0 = () => (
    <View style={styles.stepContainer}>
      ...
      <View style={styles.cardsContainer}>
        <AccountTypeCard
          title="BeamPay User"
          description="Receive instantly from any BeamPay user via your BeamPay ID"
          Icon={BeamPayIcon}
          selected={receiveType === "BEAMPAY"}
          onPress={() => setReceiveType("BEAMPAY")}
        />
        <AccountTypeCard
      ...
      <View style={styles.qrContainer}>
        ...
        <View style={styles.idDisplaySection}>
          <View style={styles.idBadge}>
            <BeamPayIcon width={18} height={18} />
          </View>
          <View style={styles.idTextContainer}>
            <Text style={styles.idLabel}>
              {receiveType === "BEAMPAY" ? "BeamPay ID" : "Wallet Address"}
            </Text>
            <Text style={styles.idValue}>
              {receiveType === "BEAMPAY" ? blinkId : walletAddress}
            </Text>
          </View>
        </View>
