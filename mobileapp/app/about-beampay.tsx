...
export default function AboutBeamPayScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>About BeamPay</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      >
        ...
        <View style={styles.heroSection}>
          <Text style={styles.heroTitle}>BeamPay</Text>
          <Text style={styles.heroSubtitle}>Fast. Secure. Seamless.</Text>
          <Text style={styles.heroDescription}>
            BeamPay is a next-generation payment and transfer platform designed to
            make moving money as easy as sending a message. Whether you're a
            user sending funds to friends or a merchant accepting payments, BeamPay
        ...
        <Section title="How It Works" icon="settings-outline">
          BeamPay leverages advanced blockchain technology to ensure near-instant
          settlements. Simply scan a QR code, enter a BeamPay ID, or tap to pay.
        ...
        >
          Security is at the heart of everything we do. BeamPay uses
        ...
        <View style={styles.ctaCard}>
          ...
          <Text style={styles.ctaText}>
            Join thousands of users and merchants already using BeamPay for their
            daily transactions.
          </Text>
          <TouchableOpacity
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            © 2026 BeamPay. All rights reserved.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
