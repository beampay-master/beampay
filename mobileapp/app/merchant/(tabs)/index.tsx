  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      <View style={styles.header}>
        <BeamPayLogo width={80} height={38} />
        <TouchableOpacity
      ...
      >
        <View style={styles.balanceCard}>
          ...
          <View style={styles.BeamPayIdContainer}>
            <Text style={styles.BeamPayIdLabel}>BeamPay ID</Text>
            <View style={styles.BeamPayIdRow}>
              <Text style={styles.BeamPayIdValue}>Ebubeone.BeamPay</Text>
              <TouchableOpacity>
