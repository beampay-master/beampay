...
use super::parser::{parse_beampay_event, BeamPayEvent};
        ...
        match poll_soroban_events(&rpc_url, cursor).await {
            Ok((events, latest_ledger)) => {
                ...
                for event in &events {
                    ...
                    match parse_beampay_event(&guessed_topic, event) {
                        BeamPayEvent::YieldDeposited(e) => {
