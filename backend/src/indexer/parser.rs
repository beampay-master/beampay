...
pub fn parse_beampay_event(topic: &str, value: &Value) -> BeamPayEvent {
    match topic {
        "YieldDeposited" => {
            ...
            BeamPayEvent::YieldDeposited(YieldDepositedEvent {
                address,
                amount,
                tx_hash,
            })
        ...
        "YieldWithdrawn" => {
            ...
            BeamPayEvent::YieldWithdrawn(YieldWithdrawnEvent {
                address,
                amount,
                tx_hash,
            })
        ...
        "YieldRateUpdated" => {
            ...
            BeamPayEvent::YieldRateUpdated(YieldRateUpdatedEvent { apy, tx_hash })
        }
        _ => BeamPayEvent::Unknown,
    }
}
