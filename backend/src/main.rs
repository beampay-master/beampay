...
use beampay_backend::api;
use beampay_backend::config;
use beampay_backend::db;
use beampay_backend::indexer;
use beampay_backend::services;
    ...
    tracing_subscriber::registry()
        .with(
            tracing_subscriber::EnvFilter::try_from_default_env()
                .unwrap_or_else(|_| "beampay-backend=debug,tower_http=debug".into()),
        )
        .with(tracing_subscriber::fmt::layer().json())
        .init();

    tracing::info!("Initializing BeamPay Social Backend...");
